    ...
    <section className="max-w-5xl mx-auto py-12 md:py-16 px-4 animate-fade-in">
      <div className="text-center space-y-8">
        <h2 className="text-3xl md:text-4xl font-bold leading-tight animate-slide-up">
          I bridge engineering and strategy to build products people love and businesses rely on.
        </h2>
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-8 animate-slide-up stagger-2">
